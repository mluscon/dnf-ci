...
/usr/bin/mock --quiet --configdir="$1" --root="$2" --install python3-pep8 python3-pyflakes pylint

/usr/bin/mock --quiet --configdir="$1" --root="$2" --unpriv --shell "cd '$MOCK_DIR'; ./test-python3-code.sh"; EXIT=$?
